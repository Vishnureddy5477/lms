...
/**
 * Raw SQL against "exam_system.manage_programming_technical_mock_marks" —
 * copied faithfully from student-performance.jsp's Programming Mock sub-tab.
 */
@Repository
public class ManageProgrammingTechnicalMockMarksDao {

    private final JdbcTemplate jdbcTemplate;

    public ManageProgrammingTechnicalMockMarksDao(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public List<SkillTrackerMockRow> findByRegNo(String regNo) {
        String sql = "SELECT * FROM exam_system.manage_programming_technical_mock_marks " +
